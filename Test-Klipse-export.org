...
#+NAME: src-gif-js-worker-url
#+BEGIN_SRC clojure :exports none
(def gif-worker-src (.-textContent (. js/document (getElementById "gif-js-worker-code"))))
(def worker (let[blob (js/Blob. #js [gif-worker-src] #js {:type "application/javascript"})]
...
#+call: inline-klipse-clojure-s('("src-gif-js-worker-url"))

#+call: inline-klipse-clojure-s('("src-test-gif-js"))
